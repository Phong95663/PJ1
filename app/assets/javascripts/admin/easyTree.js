        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).html();
                    $(this).html('<span><span class="glyphicon"></span><span class="m_span "></span> </span>');
            ...
            //             var item = $('<li><span><span class="glyphicon glyphicon-file"></span>' + $(createInput).find('input').val() + '</span></li>');
